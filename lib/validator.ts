...
// Schema for inserting an ecosystem
export const insertEcosystemSchema = z.object({
  title: z.string().min(3, 'Name must be at least 3 characters'),
  status: z.string().min(3, 'Slug must be at least 3 characters'),
  content: z.string().min(3, 'Category must be at least 3 characters'),
});
