  ...
  return (
    <div className='mx-auto flex max-w-[1200px] flex-col items-center justify-center pt-4'>
      ...
      <h1 className='ml-8  text-xl font-bold lg:ml-0 mb-4'>
        This website is under construction. Please contact
        sigfus@natturuvinir.is for more information
      </h1>
      <Link href='/sign-in' className='mb-4 text-left'>
