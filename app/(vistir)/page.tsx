...
export default async function Vistir() {
  ...
  // Redirect if no ecosystems. Used because we don't want to display the page if there are no ecosystems
  // And that happens sometimes after navigation to another page for some reasons not yet known
